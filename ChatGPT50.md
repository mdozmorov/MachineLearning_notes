...
**Source:**  
https://www.reddit.com/r/PromptEngineering/comments/1pifidh/chatgpt_secret_tricks_cheat_sheet_50_power/
...
**Usage:** `ACT AS: Career Coach — Resume tips`
...
**FEYNMAN TECHNIQUE**  
Explains topics to ensure deep understanding.  
...
**3-PASS ANALYSIS**  
Performs a three-phase content review.  
...
**FORMAT AS: [Type]**  
Formats responses as tables, lists, etc.  
**Usage:** `FORMAT AS: Table — Electric cars comparison`

**BEGIN WITH / END WITH**  
Controls how AI starts or ends output.  
**Usage:** `BEGIN WITH: Summary — Analyze this case study`

**REWRITE AS: [Style]**  
Rewrites text in a desired style.  
...
**NO AUTOPILOT**  
Forces avoidance of default answers.  
**Usage:** `NO AUTOPILOT: Creative ad ideas`

**MULTI-AGENT SIMULATION**  
Simulates conversations between roles.  
...
- ECHO-FREEZE — Lock specific reasoning paths  
...
- TRUTH_GATE — Accuracy verification filters  
...
- Stack tokens for powerful prompts:  
  `ACT AS: Project Manager — SWOT — FORMAT AS: Table — GUARDRAIL: Factual only`
...
This document is shared for informational and educational purposes only. I do not claim ownership of the original content and do not pretend to have any rights to it. All credit belongs to the original source and contributors.
